...
extern "C" fn rust_entry() -> ! {
    ...
    common::run_el2_rpi_boot_like(
        "vgic_e2e_physical_ppi_rpi_boot",
        guest_entry_physical_ppi_rpi_boot,
    )
}

extern "C" fn guest_entry_physical_ppi_rpi_boot(shared: *mut common::Shared) -> ! {
...
fn panic_handler(info: &core::panic::PanicInfo<'_>) -> ! {
    common::panic_exit("vgic_e2e_physical_ppi_rpi_boot", info)
}
