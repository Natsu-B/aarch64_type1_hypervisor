...
extern "C" fn rust_entry() -> ! {
    ...
    common::run_el2("vgic_e2e_physical_ppi", guest_entry_physical_ppi)
}
...
extern "C" fn guest_irq_handler_trampoline() {
    ...
    match intid {
        ...
        other => {
            ...
            common::shared_set_fail_if_unset(shared, common::FAIL_PHYS_PPI_UNEXPECTED_INTID);
        }
    }
...
fn panic_handler(info: &core::panic::PanicInfo<'_>) -> ! {
    common::panic_exit("vgic_e2e_physical_ppi", info)
}
